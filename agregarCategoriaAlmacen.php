 ...
 if(isset($_POST['add_cat'])){
   ...
   if(empty($errors)){
      ...
      if($db->query($sql)){
        ...
        redirect('agregarCategoriaAlmacen.php',false);
      } else {
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <strong>
            ...
            <span>Agregar Categoría Almacen</span>
         </strong>
        </div>
        <div class="panel-body">
          <form method="post" action="agregarCategoriaAlmacen.php">
              ...
              <?php foreach ($all_categories as $cat):?>
                <tr>
                    ...
                    <td class="text-center">
                      <div class="btn-group">
                        <a href="editarCategoriaAlmacen.php?id=<?php echo (int)$cat['id'];?>"  class="btn btn-xl btn-warning" data-toggle="tooltip" title="Editar">
                        ...
                        <a class="btn btn-xl btn-danger" data-toggle="tooltip" title="Eliminar" data-confirm onclick="new jBox('Notice', {content: 'Eliminado', color: 'red', attributes: {y: 'bottom'}, onCreated: function () {
                          location.href = 'eliminarCategoriaAlmacen.php?id=<?php echo (int)$cat['id'];?>'}})">
