...
/*--------------------------------------------------------------*/
/* Función para la identificación del conteo por nombre de tabla
/*--------------------------------------------------------------*/
...
/*--------------------------------------------------------------*/
 ...
 /*--------------------------------------------------------------*/
  ...
  /*--------------------------------------------------------------*/
  /* Buscar todos los usuarios uniéndose a la tabla de
  usuarios y la tabla de usuario grupos
  /*--------------------------------------------------------------*/
 ...
 function updateLastLogIn($user_id)
  ...
  /*--------------------------------------------------------------*/
   ...
   /* ÚNASE a la tabla de base de datos de categorías y medios
   /*--------------------------------------------------------------*/
   /*Stock Products*/
   function join_product_table(){
     global $db;
     $sql  =" SELECT p.id,p.name,p.quantity,p.buy_price,p.titulo, p.titulo, p.editorial,p.descriptores, p.descriptores,p.sale_price,p.media_id,p.date,p.existencia,c.name";
